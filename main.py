...
flags.DEFINE_string("dataset", "tissue64/default", "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("input_fname_pattern", "*.png", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "tissue64", "Directory name to save the image samples [samples]")
...
flags.DEFINE_integer("generate_test_images", 256, "Number of images to generate during test. [100]")
FLAGS = flags.FLAGS
