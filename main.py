...
flags.DEFINE_string("dataset", "tissue%d/default" % imsize, "The name of dataset [celebA, mnist, lsun]")
flags.DEFINE_string("input_fname_pattern", "*.png", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "tissue%d" % imsize, "Directory name to save the image samples [samples]")
flags.DEFINE_integer("sample_num", 64, "Number of images to preview as sample")
